  ...
  <fieldset class="form-group">
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" name="user_type" id="gridRadios1" value="Branch">
          <label class="form-check-label" for="gridRadios1">
            Branch
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="user_type" id="gridRadios1" value="Admin">
          <label class="form-check-label" for="gridRadios1">
            Admin
          </label>
        </div>
