...
$loc = $this->session->userdata('location'); ?>
		...
		<table class="table">
			...
			<tbody>
					...
					$i = 1;$grand_due=$grand_comm=$pay=0;$qty=0;
					foreach ($deliver as $stk) {
						$t_qty = $stk['quantity'] + $stk['stock_left'];
						$grand_due += $stk['due_amount'];
						$grand_comm += $stk['branch_comm'];
						echo '<tr>';
						echo '<td>'.$i.'</td>';
						echo '<td>'.$stk['item_name'].'</td>';
						echo '<td>'.$t_qty.'</td>';
						echo '<td>'.$stk['item_price'].'</td>';
						echo '<td>'.$stk['branch_comm'].'</td>';
						echo '<td>'.$stk['quantity'].'</td>';
						echo '<td>'.$stk['stock_left'].'</td>';
						// echo '<td>'.$stk['actual_amount'].'</td>';
						echo '<td>'.$stk['actual_amount'].'</td>';
						echo '</tr>';
						echo '<tr>';
							echo '<td></td>';
						...
						echo '<tr>';
							...
							echo '<td></td>';
							echo '<td></td>';
							echo '<td><b>Due Amount: </b></td>';
							// echo '<td></td>';
							echo '<td><b>'.$stk['due_amount'].'</b></td>';
						echo '</tr>';
					...
					echo '<tr>';
							...
							echo '<td></td>';
							echo '<td></td>';
							echo '<td style="color: red;">Total Due Amount: </td>';
							// echo '<td></td>';
							echo '<td style="color: red;">'.$grand_due.'</td>';
						echo '</tr>';
						echo '<tr>';
							echo '<td></td>';
							echo '<td></td>';
							...
							echo '<td></td>';
							echo '<td></td>';
							echo '<td style="color: green;">Total Commission: </td>';
							// echo '<td></td>';
							echo '<td style="color: green;">'.$grand_comm.'</td>';
						echo '</tr>';
				?>
			</tbody>
		</table>
