...
<div class="container-fluid">
	<div class="card card_prof">
		<h4 class="mt-3 mb-4" style="text-align: center;">Delivered/Cancelled Entries </h4>
				...
				foreach ($canc as $val) {
					...
					echo '<tr>';
						...
						if ($val['status'] == 'Delivered'){
							echo '<td><button class="btn btn-success">'.$val['status'].'</button></td>';
						}else{
							echo '<td><button class="btn btn-danger">'.$val['status'].'</button></td>';
						}
